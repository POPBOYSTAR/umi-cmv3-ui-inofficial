...
export default function Home() {
  ...
  const PageContent = () => {
   ...
   `}
        ...
        <Center><p style = {{color:white}}>{price}</p>><b>ALWAYS ONLINE NEEDS YOUR HELP IN THE DESIGN CONTEST!</b></p></Center>
        <Card>
          <CardHeader>
            <Flex minWidth='max-content' alignItems='center' gap='2'>
              <Box>
                <Heading size='md'>{headerText} NFT</Heading>
              </Box>
              {loading ? (<></>) : (
                <Flex justifyContent="flex-end" marginLeft="auto">
                  <Box background={"white"} borderRadius={"5px"} minWidth={"50px"} minHeight={"50px"} p={2} >
                    <VStack >
